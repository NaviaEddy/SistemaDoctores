                        ...
                        <tbody>
                            <?php
                                if($data['patients']->num_rows == 0){
                                    ...
                                    <a class="non-style-link" href="../../controllers/doctor/patient_controller.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Show all Patients &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
